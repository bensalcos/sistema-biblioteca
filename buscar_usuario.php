...
?>
        ...
        <form method="POST" action="<?php echo 'usuarios.php'; ?>">
                ...
                <ul class="list-group list-group-flush" style="text-decoration: none;">
                    <li class="list-group-item">
                        <div style="margin-right: 6px;">
                            <div style="margin-right:6px;"><b><?php echo "</b>Nombre: <b>" . $nombre . ' ' . $apellido . "</b>, </b>Rut:<b> $rut,   </b>Tipo de usuario: <b>" . $tipo; ?></b></div>
                        </div>
                    </li>
                </ul>
            </button>
